(function () {
  ...
  self.onDocumentReady = function(){
    Apeiron.home.logLines([
      ...
      [" - Shield Region 1: <span class='warn report-status'>Offline - Insufficient Power</span>", 100],
      [" - Shield Region 2: <span class='warn report-status'>Offline - Insufficient Power</span>", 100],
