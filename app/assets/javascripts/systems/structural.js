(function () {
  ...
  self.onDocumentReady = function(){
    ...
    Apeiron.home.logLines([
      ...
      ["Sector 4: <span class='warn'>Repairs complete.</span> Structural Integrity: <span class='good'>83%</span>", 200],
      ...
      ["Summary: Critical structures repaired. Probabilty of surviving launch: <span class='warn'>78%</span>", 100]
    ]);
